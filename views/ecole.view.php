...
<div class="page-heading text-center">
	<div class="container zoomIn animated">	
		<h1 class="page-title">ONG-UIFS & LES ECOLES <span class="title-under"></span></h1>
		<p class="page-description">
		ONG-UIFS nous disons non à la déscolarisation, alphabetisation et au banditisme en milieu scolaire.
		</p>	
	</div>
</div>
<div class="main-container">
	<div class="our-causes fadeIn animated">
        <div class="container">
            <h2 class="title-style-1">nos dons au niveau scolaire <span class="title-under"></span></h2>
            <div class="row">     				
		        <div class="col-md-3 col-sm-6">
                    <div class="cause">
                        <img src="assets/images/causes/09.png" alt="" class="cause-img">
	                ...
	                <div class="col-md-3 col-sm-6">
	                    <div class="cause">
	                        <img src="assets/images/causes/10.png" alt="" class="cause-img">
